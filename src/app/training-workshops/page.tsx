      ...
      if (window.Calendly && !isInitialized) {
        ...
        if (widgetElement && widgetElement.children.length === 0) {
          window.Calendly.initInlineWidget({
            url: 'https://calendly.com/dayoneexecutive/team-coaching-training-discovery-call-corporate?month=2025-09',
      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-black/50 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-4">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-2">
            ...
            <Link href="/training-workshops" className="text-xs px-3 py-1.5 rounded-full border border-gold-gradient bg-gold-gradient/10 text-gold-gradient font-medium hover:bg-gold-gradient/20 transition-all duration-300">
              Training & Workshops
            </Link>
            ...
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[.06] px-4 py-2 mb-6">
                <span className="flex items-center gap-2" aria-hidden style={{ color: "var(--gold-start)" }}>
                  ...
                  <span className="text-sm font-medium">Training & Workshops</span>
                </span>
              </div>
              
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                Skip the Learning Curve — <span className="text-gold-gradient">Start Seeing Results Now</span>
              </h1>
              ...
              <div className="order-2 lg:order-1">
                <div className="bg-gradient-to-br from-white/[.02] to-white/[.01] border border-white/10 rounded-2xl p-8 flex flex-col justify-center items-center h-full">
                  ...
                  <div className="text-center mt-6">
                    <div className="text-2xl font-bold text-gold-gradient mb-2">Interactive Learning</div>
                    <p className="text-sm text-soft-gray font-medium">Hands-on Workshop Experience</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-6 text-lg text-soft-gray leading-relaxed">
                    ...
                    <div className="grid grid-cols-2 gap-6 mt-8">
                      <div className="text-center">
                        <div className="text-3xl font-bold text-gold-gradient mb-2">Custom</div>
                        <p className="text-sm text-soft-gray font-medium">Tailored to Your Needs</p>
                      </div>
                      <div className="text-center">
                        <div className="text-3xl font-bold text-gold-gradient mb-2">Interactive</div>
                        <p className="text-sm text-soft-gray font-medium">Hands-on Learning</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-white/[.02] to-white/[.01] border border-white/10 rounded-2xl p-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-soft-gray">
                    Schedule a consultation to discuss your training and workshop needs.
                  </p>
                </div>
                <div 
                  id="calendly-widget"
